...
public class HttpFragment extends BaseFragment {
    ...
    private void onTest2Click(View view) throws FileNotFoundException {
        ...
        RequestParams params = new RequestParams("http://192.168.1.47:8080/FileUpload/FileUploadServlet");
...
//                null); // 如果文件没有扩展名, 最好设置contentType参数.
    ...
    private void onTest6Click(View view) throws DbException {
        ...
        String url = "http://vf2.mtime.cn/Video/2017/02/06/mp4/170206092237963117_480.mp4";
